...
function loadTable() {
    $.ajax({
        type: 'GET',
        url: "http://flip2.engr.oregonstate.edu:17510/get-workouts",
 ...
 $(document).ready(function() {
      if (window.location.pathname == '/edit-row') {
        ...
        $.ajax({
            type: 'GET',
            url: "http://flip3.engr.oregonstate.edu:17510/get-a-workout?id=" + id,
...
function submit () {
    ...
    $.ajax({
        type: 'GET',
        url: "http://flip2.engr.oregonstate.edu:17510/submit?name=" + name + "&weight=" + weight + "&weightUnit=" + weightUnit + "&reps=" + reps + "&date=" + date,
        success: function (id) {
            data.id = id;
            drawRow(data);
        }
...
function save() {
    ...
    $.ajax({
        type: 'GET',
        url: "http://flip2.engr.oregonstate.edu:17510/edit-save?id=" + id + "&name=" + name + "&weight=" + weight + "&lbs=" + lbs + "&reps=" + reps + "&date=" + date,
        success: function () {
            window.location = "http://flip2.engr.oregonstate.edu:17510/";
        }
    });
}
...
function edit(id) {
    $.ajax({
        type: 'GET',
        url: "http://flip2.engr.oregonstate.edu:17510/get-a-workout?id=" + id,
        success: function (data) {
            var rowData = JSON.parse(data)[0];            
            window.location = "http://flip2.engr.oregonstate.edu:17510/edit-row?id=" + rowData.id;
...
function deleteRow(id) {
    $.ajax({
        type: 'GET',
        url: "http://flip2.engr.oregonstate.edu:17510/delete?id=" + id,
        success: function () {
            $("#" + id).remove();
        }
    });
